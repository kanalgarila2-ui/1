...
val VSPrimary     = Color(0xFF8B5CF6); val VSPrimaryDark = Color(0xFF7C3AED)
val VSPrimaryLite = Color(0xFFA78BFA); val VSSecondary   = Color(0xFF06B6D4)
val VSGreen       = Color(0xFF10B981); val VSRed         = Color(0xFFEF4444)
val VSYellow      = Color(0xFFF59E0B); val VSFrozen      = Color(0xFF67E8F9)
val VSBubbleOwn   = Color(0xFF6D28D9); val VSBubbleOther = Color(0xFF1E1E3A)
val VSBubbleBot   = Color(0xFF064E3B)
val VSBgDark      = Color(0xFF0F0F17); val VSSurfDark    = Color(0xFF1A1A2E)
val VSCardDark    = Color(0xFF1E1E32); val VSBorderDark  = Color(0xFF2D2D50)
val VSOnDark      = Color(0xFFE8E8F5); val VSMutedDark   = Color(0xFF8888AA)
val VSBgLight     = Color(0xFFF8F7FF); val VSSurfLight   = Color(0xFFFFFFFF)
val VSCardLight   = Color(0xFFF3F2FF); val VSBorderLight = Color(0xFFDDDDFF)
val VSOnLight     = Color(0xFF1A1A2E); val VSMutedLight  = Color(0xFF666688)
