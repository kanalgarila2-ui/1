...
val AdminPrimary   = Color(0xFF00B894); val AdminSecondary = Color(0xFF8B5CF6)
val AdminBg        = Color(0xFF0A0A0F); val AdminSurf      = Color(0xFF131320)
val AdminCard      = Color(0xFF1A1A2E); val AdminBorder    = Color(0xFF2D2D50)
val AdminOn        = Color(0xFFE8E8F5); val AdminMuted     = Color(0xFF8888AA)
val AdminGreen     = Color(0xFF10B981); val AdminRed       = Color(0xFFEF4444)
